...
const CATEGORIES = [
  {
    ...
    blurb: "Sterile instruments, gloves, masks and essential surgical consumables.",
    image:
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          ...
          <div>
            ...
            <p className="mt-5 max-w-xl text-sm leading-relaxed text-slate-600 sm:text-base">
              Source certified medical supplies and healthcare equipment
              from a single trusted B2B procurement platform.
            </p>
          </div>
          ...
          {CATEGORIES.map((category, index) => (
            ...
            >
              ...
              <div className="p-5 sm:p-6">
                ...
                <p className="mt-4 text-[11px] font-semibold uppercase tracking-[0.18em] text-[#0F4C81]">
                  Explore products
                </p>
              </div>
            </Link>
